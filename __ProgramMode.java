...
@Autonomous(name = "Program Mode", group = "Dev")
public class __ProgramMode extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while(opModeIsActive()){
            ...
            telemetry.addData("Avg Pos", Math.round((robot.front_left.getCurrentPosition() + robot.front_right.getCurrentPosition() + robot.back_left.getCurrentPosition() + robot.back_right.getCurrentPosition())/4));
        }
